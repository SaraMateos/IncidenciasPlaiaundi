                    ...
                    <form class="my-3" method="post" action="/incidencias/modificar/{{ $incidencia->id }}">
                        ...
                        <div class="form-group row">
                            <div class="col-12">
                                ...
                                <textarea type="text" class="form-control" name="descripcion" id="descripcion" placeholder="Descripción">{{ $incidencia->descripcion }}</textarea>
                            </div>
                        </div>
                        ...
                        <div>
                            <a href="/incidencias"><input class="btnVolver" type="button" value="Cancelar"></a>
