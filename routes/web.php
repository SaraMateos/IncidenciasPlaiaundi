...
//Home
Route::get('/incidencias', [App\Http\Controllers\HomeController::class, 'inicio']);
Route::get('/admin/incidencias', [App\Http\Controllers\HomeController::class, 'adminHome'])->middleware('is_admin');
